...
class Rcl_Public_Form_Manager extends Rcl_Public_Form_Fields {
	...
	function form_navi() {
		...
		$content .= '<li><a class="action-form" href="' . wp_nonce_url( admin_url( 'admin.php?page=manage-public-form&form-action=new-form&post-type=' . $this->post_type . '&form-id=' . ($form_id + 1) ), 'rcl-form-action' ) . '"><i class="rcli fa-plus"></i> ' . __( 'Add form', 'usp-publication' ) . '</a></li>';
